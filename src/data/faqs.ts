export const pricingFaqs = [
  ...
  },
  {
    ...
    answer:
      "The only ongoing costs are optional: hosting ($10-20/month), domain name ($15/year), and maintenance packages (starting at $69/month). We'll help you set up affordable hosting and can manage everything for you if preferred.",
  },
];
